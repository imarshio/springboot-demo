...
public class SuppressWarningsName {
    ...
    public static final String SPRING_JAVA_AUTOWIRING_INSPECTION = "SpringJavaAutowiringInspection";
    public static final String SPRING_JAVA_AUTOWIRED_MEMBERS_INSPECTION = "SpringJavaAutowiredMembersInspection";
